...
def hypercube_to_hypersphere_surface(hypercube_points: np.ndarray, half_hypersphere: bool) -> np.ndarray:
    ...
    surface_points = (
        surface_points.T / np.linalg.norm(surface_points, axis=-1)
    ).T  # correct numerical round-off errors
